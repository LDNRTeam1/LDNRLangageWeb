<?php
    ...
    //On lit le fichier 'tchatContent.html' et on stocke la réponse dans une variable (de type tableau)
    ...
    //On écrit le contenu du tableau $tchatContent dans le fichier tchatContent.html
